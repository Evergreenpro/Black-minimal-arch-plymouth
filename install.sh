...
THEME_DIR="/usr/share/plymouth/themes/Black-minimal-arch"
...
if [[ $1 == "install" ]]; then
        ...
        if [[ ! -e "./Black-minimal-arch.plymouth" ]]; then
        ...
        plymouth-set-default-theme -R Black-minimal-arch
        ...
        FALLBACK_THEME=$(plymouth-set-default-theme --list | grep -v "Black-minimal-arch" | head -n 1)
